...
public final class ColorSpecs {
    ...
    public static ColorSpec get() {
        return get(ColorSpecVersion.SPEC_2021);
    }

    public static ColorSpec get(ColorSpecVersion specVersion) {
        return get(specVersion, false);
    }

    public static ColorSpec get(ColorSpecVersion specVersion, boolean isExtendedFidelity) {
        return specVersion == ColorSpecVersion.SPEC_2025 ? SPEC_2025 : SPEC_2021;
    }
