...
import static org.glavo.monetfx.internal.dynamiccolor.TonePolarity.RELATIVE_LIGHTER;
import static org.glavo.monetfx.ColorStyle.*;
...
final class ColorSpec2025 extends ColorSpec2021 {
  ...
  public DynamicColor background() {
    ...
    return super.background().toBuilder()
        .extendSpecVersion(ColorSpecVersion.SPEC_2025, color2025)
        .build();
  }
  ...
  public DynamicColor onBackground() {
    ...
    return super.onBackground().toBuilder()
        .extendSpecVersion(ColorSpecVersion.SPEC_2025, color2025Builder.build())
        .build();
  }
