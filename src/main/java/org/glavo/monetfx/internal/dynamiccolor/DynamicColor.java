...
public final class DynamicColor {
    ...
    public static class Builder {
        ...
        // @CanIgnoreReturnValue
        Builder extendSpecVersion(ColorSpecVersion specVersion, DynamicColor extendedColor) {
        ...
        private void validateExtendedColor(ColorSpecVersion specVersion, DynamicColor extendedColor) {
